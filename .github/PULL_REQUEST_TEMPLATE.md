...
<!-- The reasoning matters more than the diff. What was wrong, or what does this
     make possible? Link the issue if there is one: Fixes #123 -->
...
- [ ] Tested against live Steam accounts <!-- if not, say why -->
...
- [ ] No credentials, `maFile`s, tokens, account names, or Steam IDs in the diff
