...
- [~] Phase 3 — re-skin view render functions V2–V19 in new_public/app.js (serial, idempotent via `_P3_DONE.md`, node --check gate per view). **DONE: V2 V3 V4 V5 V6.** Remaining: V7 chart → V8 orders → V9 offers → V10 buy → V11 mass-buy → V12 sell → V13 send → V14 bans → V15 casket/tradeup → V16 CSFloat → V17 account modals → V18 import → V19 settings.
